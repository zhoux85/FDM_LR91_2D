...
int stimtime = (int)(0.6 / dt + 0.6);  //Time period during which stimulus is applied (ms)
...
int main(int argc, char* argv[])
{
	...
	clock_t start, end;
	start = clock();
	for (ncount = 0; ncount <= 160 / dt; ncount++){//simulation time is 160ms
		for (i = 1; i < nx + 1; i++){
